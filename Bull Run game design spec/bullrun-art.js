/* ============================================================
   Bull Run — shared art library (window.BRArt)
   Pure canvas drawing: tiles, props, buildings, bulls, people.
   Used by the game (Bull Run Prototype) and the Asset Sheet.
...
(function () {
  ...
  window.BRArt = { iso: iso0, hash, mul, mix, cube, decal, decalFrame, decalCorners, faceLine, diamond, shadow, label, tile, drawObj, drawItem, RARC, TW, TH };
})();
